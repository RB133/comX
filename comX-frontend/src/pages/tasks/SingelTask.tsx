    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-2xl bg-card text-card-foreground rounded-2xl overflow-hidden shadow-xl"
        >
          <div className="relative">
            <motion.button
              className="absolute top-4 right-4 p-2 bg-card rounded-full text-muted-foreground hover:bg-muted transition-colors"
          ...
          <div className="p-6 space-y-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="text-muted-foreground text-sm max-h-40 overflow-y-auto"
            >
